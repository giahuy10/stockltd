...
<script type="text/javascript">
	if (jQuery === 'undefined') {
		document.addEventListener("DOMContentLoaded", function (event) {
			jQuery('#form-voucher').submit(function (event) {
...
<div class="voucher-edit front-end-edit">
	...
	<form id="form-voucher"
		  action="<?php echo JRoute::_('index.php?option=com_onecard&task=voucher.save'); ?>"
...
<?php echo $this->form->renderField('brand'); ?>
		...
		<div class="button-div">
			...
			<a href="<?php echo JRoute::_('index.php?option=com_onecard&task=voucherform.cancel'); ?>"
