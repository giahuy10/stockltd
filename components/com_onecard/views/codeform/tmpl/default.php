...
<script type="text/javascript">
	if (jQuery === 'undefined') {
		document.addEventListener("DOMContentLoaded", function (event) {
			jQuery('#form-code').submit(function (event) {
...
<div class="code-edit front-end-edit">
	...
	<form id="form-code"
		  action="<?php echo JRoute::_('index.php?option=com_onecard&task=code.save'); ?>"
...
<?php echo $this->form->renderField('status'); ?>
		...
		<div class="button-div">
			...
			<a href="<?php echo JRoute::_('index.php?option=com_onecard&task=codeform.cancel'); ?>"
