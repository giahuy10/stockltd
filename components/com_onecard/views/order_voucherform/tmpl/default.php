...
<script type="text/javascript">
	if (jQuery === 'undefined') {
		document.addEventListener("DOMContentLoaded", function (event) {
			jQuery('#form-order_voucher').submit(function (event) {
...
<div class="order_voucher-edit front-end-edit">
	...
	<form id="form-order_voucher"
		  action="<?php echo JRoute::_('index.php?option=com_onecard&task=order_voucher.save'); ?>"
...
<?php echo $this->form->renderField('price'); ?>
		...
		<div class="button-div">
			...
			<a href="<?php echo JRoute::_('index.php?option=com_onecard&task=order_voucherform.cancel'); ?>"
