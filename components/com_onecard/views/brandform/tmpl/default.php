...
<div class="brand-edit front-end-edit">
	...
	<form id="form-brand"
		  action="<?php echo JRoute::_('index.php?option=com_onecard&task=brand.save'); ?>"
...
<?php echo $this->form->renderField('ncc'); ?>
		...
		<div class="button-div">
			...
			<a href="<?php echo JRoute::_('index.php?option=com_onecard&task=brandform.cancel'); ?>"
