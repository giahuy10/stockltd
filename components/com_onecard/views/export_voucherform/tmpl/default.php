...
<script type="text/javascript">
	if (jQuery === 'undefined') {
		document.addEventListener("DOMContentLoaded", function (event) {
			jQuery('#form-export_voucher').submit(function (event) {
...
<div class="export_voucher-edit front-end-edit">
	...
	<form id="form-export_voucher"
		  action="<?php echo JRoute::_('index.php?option=com_onecard&task=export_voucher.save'); ?>"
...
<?php echo $this->form->renderField('created'); ?>
		...
		<div class="button-div">
			...
			<a href="<?php echo JRoute::_('index.php?option=com_onecard&task=export_voucherform.cancel'); ?>"
