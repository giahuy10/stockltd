...
<script type="text/javascript">
	if (jQuery === 'undefined') {
		document.addEventListener("DOMContentLoaded", function (event) {
			jQuery('#form-order').submit(function (event) {
...
<div class="order-edit front-end-edit">
	...
	<form id="form-order"
		  action="<?php echo JRoute::_('index.php?option=com_onecard&task=order.save'); ?>"
...
<?php echo $this->form->renderField('onecard_point'); ?>
<?php echo $this->form->renderField('vpoint'); ?>
<?php echo $this->form->renderField('vpoint_client'); ?>
<?php echo $this->form->renderField('coupon_code'); ?>
		...
		<div class="button-div">
			...
			<a href="<?php echo JRoute::_('index.php?option=com_onecard&task=orderform.cancel'); ?>"
