...
<script type="text/javascript">
	if (jQuery === 'undefined') {
		document.addEventListener("DOMContentLoaded", function (event) {
			jQuery('#form-contract').submit(function (event) {
...
<div class="contract-edit front-end-edit">
	...
	<form id="form-contract"
		  action="<?php echo JRoute::_('index.php?option=com_onecard&task=contract.save'); ?>"
...
<?php echo $this->form->renderField('ncc'); ?>
		...
		<div class="button-div">
			...
			<a href="<?php echo JRoute::_('index.php?option=com_onecard&task=contractform.cancel'); ?>"
