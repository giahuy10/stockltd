...
<script type="text/javascript">
	if (jQuery === 'undefined') {
		document.addEventListener("DOMContentLoaded", function (event) {
			jQuery('#form-ncc').submit(function (event) {
...
<div class="ncc-edit front-end-edit">
	...
	<form id="form-ncc"
		  action="<?php echo JRoute::_('index.php?option=com_onecard&task=ncc.save'); ?>"
...
<?php echo $this->form->renderField('description'); ?>
		...
		<div class="button-div">
			...
			<a href="<?php echo JRoute::_('index.php?option=com_onecard&task=nccform.cancel'); ?>"
