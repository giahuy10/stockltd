...
<script type="text/javascript">
	if (jQuery === 'undefined') {
		document.addEventListener("DOMContentLoaded", function (event) {
			jQuery('#form-event').submit(function (event) {
...
<div class="event-edit front-end-edit">
	...
	<form id="form-event"
		  action="<?php echo JRoute::_('index.php?option=com_onecard&task=event.save'); ?>"
...
<?php echo $this->form->renderField('partner'); ?>
		...
		<div class="button-div">
			...
			<a href="<?php echo JRoute::_('index.php?option=com_onecard&task=eventform.cancel'); ?>"
