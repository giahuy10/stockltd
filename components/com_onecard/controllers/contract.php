 ...
 * @since  1.6
 */
class OnecardControllerContract extends JControllerLegacy
{
	/**
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('Contract', 'OnecardModel');
	...
	public function publish()
	{
		...
		if ($user->authorise('core.edit', 'com_onecard') || $user->authorise('core.edit.state', 'com_onecard'))
		{
			...
			if (!$item)
			{
				...
				$this->setRedirect(JRoute::_('index.php?option=com_onecard&view=contracts', false));
			}
			else
			{
