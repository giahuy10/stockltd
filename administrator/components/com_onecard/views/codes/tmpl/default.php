...
if ($saveOrder)
{
    $saveOrderingUrl = 'index.php?option=com_onecard&task=codes.saveOrderAjax&tmpl=component';
    JHtml::_('sortablelist.sortable', 'codeList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<form action="<?php echo JRoute::_('index.php?option=com_onecard&view=codes'); ?>" method="post"
    ...
    <div id="j-main-container" class="span10">
        ...
        <div id="j-main-container">
            ...
            <table class="table table-striped" id="codesList">
                <thead>
                <tr>
...
<th>		<?php echo $item->id; ?>		</th>
				...
				<?php if (isset($this->items[0]->state)): ?>
                    <td class='center'>
                        <?php echo JHtml::_('jgrid.published', $item->state, $i, 'codes.', $canChange, 'cb'); ?>
					</td>
                <?php endif; ?>
