...
if ($saveOrder)
{
    $saveOrderingUrl = 'index.php?option=com_onecard&task=events.saveOrderAjax&tmpl=component';
...
<th>		<?php echo JHtml::_('grid.sort', 'COM_ONECARD_FORM_LBL_event_STATE', 'a.`state`', $listDirn, $listOrder); ?>		</th>
...
<th>		<?php echo $item->id; ?>		</th>
				...
				<th>		
						...
						<?php if ($canEdit) : ?>
							<a href=<?php echo JRoute::_('index.php?option=com_onecard&task=event.edit&id='.(int) $item->id); ?>>
