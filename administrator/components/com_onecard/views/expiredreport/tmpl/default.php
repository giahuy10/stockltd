...
$query
    ->select(array('a.voucher as voucher_id','c.title as voucher_name','d.title as brand', 'count(*) as quantity', 'c.input_price as price', 'c.type', 'c.expired','a.used_date','c.unit as unit' ))
    ...
    ->order($db->quoteName('c.expired') . ' ASC');
