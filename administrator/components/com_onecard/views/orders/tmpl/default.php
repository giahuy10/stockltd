...
if ($saveOrder)
{
    $saveOrderingUrl = 'index.php?option=com_onecard&task=orders.saveOrderAjax&tmpl=component';
...
<th>		<?php echo JHtml::_('grid.sort', 'COM_ONECARD_FORM_LBL_order_STATE', 'a.`state`', $listDirn, $listOrder); ?>		</th>
