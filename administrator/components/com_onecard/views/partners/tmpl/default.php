...
if ($saveOrder)
{
    $saveOrderingUrl = 'index.php?option=com_onecard&task=partners.saveOrderAjax&tmpl=component';
    JHtml::_('sortablelist.sortable', 'partnerList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<th>		<?php echo JHtml::_('grid.sort', 'COM_ONECARD_FORM_LBL_partner_STATE', 'a.`state`', $listDirn, $listOrder); ?>		</th>
...
<th>		<?php echo $item->id; ?>		</th>
				...
				<th>		
						...
						<?php if ($canEdit) : ?>
							<a href=<?php echo JRoute::_('index.php?option=com_onecard&task=partner.edit&id='.(int) $item->id); ?>>
