 ...
 * @since  1.6
 */
class OnecardViewPartners extends JViewLegacy
{ 
    protected $items;
    ...
    public function display($tpl = null)
    {
        ...
        OnecardHelpersOnecard::addSubmenu('partners');
    ...
    protected function addToolbar()
    {
        ...
        JToolBarHelper::title(JText::_('COM_ONECARD_TITLE_PARTNERS'), 'partners.png');
        ...
        if (file_exists($formPath))
        {
            if ($canDo->get('core.create'))
            {
                ...
                JToolbarHelper::custom('partners.duplicate', 'copy.png', 'copy_f2.png', 'JTOOLBAR_DUPLICATE', true);
            }
        ...
        JHtmlSidebar::setAction('index.php?option=com_onecard&view=partners');
		...
		$this->extra_sidebar .= '<small><label for="filter_created_by">'.JText::_('COM_ONECARD_FORM_LBL_partner_CREATED_BY').'</label></small>';
    ...
    protected function getSortFields()
    {
        return array(
			...
			'a.`id`' => JText::_('COM_ONECARD_FORM_LBL_partner_ID'),
'a.`state`' => JText::_('COM_ONECARD_FORM_LBL_partner_STATE'),
'a.`ordering`' => JText::_(''),
'a.`created_by`' => JText::_('COM_ONECARD_FORM_LBL_partner_CREATED_BY'),
'a.`modified_by`' => JText::_('COM_ONECARD_FORM_LBL_partner_MODIFIED_BY'),
'a.`title`' => JText::_('COM_ONECARD_FORM_LBL_partner_TITLE'),
'a.`description`' => JText::_('COM_ONECARD_FORM_LBL_partner_DESCRIPTION'),
