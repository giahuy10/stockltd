...
if ($saveOrder)
{
    $saveOrderingUrl = 'index.php?option=com_onecard&task=export_vouchers.saveOrderAjax&tmpl=component';
    JHtml::_('sortablelist.sortable', 'export_voucherList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<form action="<?php echo JRoute::_('index.php?option=com_onecard&view=export_vouchers'); ?>" method="post"
    ...
    <div id="j-main-container" class="span10">
        ...
        <div id="j-main-container">
            ...
            <table class="table table-striped" id="export_vouchersList">
                <thead>
                <tr>
...
<th>		<?php echo JHtml::_('grid.sort', 'COM_ONECARD_FORM_LBL_export_voucher_STATE', 'a.`state`', $listDirn, $listOrder); ?>		</th>
...
<th>		<?php echo $item->id; ?>		</th>
				...
				<?php if (isset($this->items[0]->state)): ?>
                    <td class='center'>
                        <?php echo JHtml::_('jgrid.published', $item->state, $i, 'export_vouchers.', $canChange, 'cb'); ?>
					</td>
                <?php endif; ?>
				
				<th>		<a href="index.php?option=com_onecard&view=export_voucher&layout=edit&id=<?php echo $item->id?>"><?php echo $item->event; ?>	</a>	</th>
