 ...
 * @since  1.6
 */
class OnecardModelOrders extends JModelList
{
/**
	* Constructor.
	*
...
'subtotal','a.`subtotal`',
'total','a.`total`',
'onecard_point','a.`onecard_point`',
'vpoint','a.`vpoint`',
'vpoint_client','a.`vpoint_client`',
'coupon_code','a.`coupon_code`',
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__onecard_order` AS a');
 ...
 a.`subtotal` like $search  || 
 a.`total` like $search  || 
 a.`onecard_point` like $search  || 
 a.`vpoint` like $search  || 
 a.`vpoint_client` like $search  || 
 a.`coupon_code` like $search 
");
			}
		}
