...
<form
	...
	<div class="form-horizontal">
		...
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_INVENTORY_TITLE_VOUCHER', true)); ?>
		<div class="row-fluid">
			<div class="span10 form-horizontal">
				...
				<?php echo $this->form->renderField('modified_by'); ?>				<?php echo $this->form->renderField('code'); ?>
				<?php echo $this->form->renderField('barcode'); ?>
				<?php echo $this->form->renderField('value'); ?>
				<?php echo $this->form->renderField('merchent'); ?>
